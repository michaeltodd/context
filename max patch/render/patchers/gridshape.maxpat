...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1329.291504, 118.0, 89.0, 18.0 ],
					"text" : "prepend shape"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1410.0, 210.0, 77.0, 18.0 ],
					"text" : "prepend dim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 463.0, 753.0, 59.0, 16.0 ],
					"text" : "enable 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 463.0, 705.0, 83.0, 18.0 ],
					"text" : "route strlen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 463.0, 735.0, 59.0, 18.0 ],
					"text" : "select 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 345.0, 645.0, 121.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 345.0, 675.0, 137.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 345.0, 615.0, 239.0, 18.0 ],
					"restore" : [ "u205004256" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr drawto @bindto gridshape::drawto",
					"varname" : "drawto"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 107.0, 617.0, 59.0, 16.0 ],
					"text" : "enable 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 408.0, 393.0, 113.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 390.0, 318.0, 113.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1329.291626, 8.0, 59.0, 18.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 320.564575, 180.0, 47.0, 18.0 ],
					"text" : "active"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 299.564575, 238.0, 95.0, 16.0 ],
					"text" : "0.5 0.5 0.5 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 308.564575, 261.5, 77.0, 16.0 ],
					"text" : "0. 0. 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 320.564575, 216.0, 71.0, 18.0 ],
					"text" : "select 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 109.5, 285.0, 150.0, 18.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 101.064575, 184.0, 467.0, 18.0 ],
									"text" : "select 27 126 49 50 51 52 53 54 55 56 57 48 33 64 35 36 37 94 38 42 40 41 96"
								}
...
,
					"patching_rect" : [ 1289.291626, 435.0, 77.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Courier New",
						"default_fontsize" : 10.0,
...
,
					"patching_rect" : [ 1289.291626, 565.0, 101.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Courier New",
						"default_fontsize" : 10.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 67.0, 138.0, 88.0, 16.0 ],
									"text" : "storage_close"
								}
...
,
					"patching_rect" : [ 1322.249878, 528.0, 107.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Courier New",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1322.249878, 615.0, 155.0, 18.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1327.958374, 480.0, 15.583313, 18.0 ],
					"rounded" : 0.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1289.291626, 415.0, 47.0, 18.0 ],
					"text" : "active"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1230.0, 330.0, 221.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 83.0, 197.435425, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 408.0, 375.0, 275.0, 18.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr cull_face @bindto gridshape::cull_face",
					"varname" : "cull_face"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 390.0, 300.0, 275.0, 18.0 ],
					"restore" : [ 0, 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr poly_mode @bindto gridshape::poly_mode",
					"varname" : "poly_mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1333.923584, 168.0, 203.0, 18.0 ],
					"restore" : [ 100, 100 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr dim @bindto gridshape::dim",
					"varname" : "dim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1333.923584, 150.0, 161.0, 18.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "DIM" ],
						"parameter_enable" : 0
					}
,
					"text" : "pattr right9 @initial DIM",
					"varname" : "right9"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 408.0, 240.0, 119.0, 18.0 ],
					"text" : "unpack 0. 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 570.0, 315.0, 167.0, 18.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "ALPHA" ],
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1005.840027, 150.0, 179.0, 18.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "ROTATE" ],
						"parameter_enable" : 0
					}
,
					"text" : "pattr left13 @initial ROTATE",
					"varname" : "left13"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "float", "float", "float", "float" ],
					"patching_rect" : [ 1005.840027, 186.0, 119.0, 18.0 ],
					"text" : "unpack 0. 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1005.840027, 168.0, 239.0, 18.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ 0.0, 0.0, 1.0, 0.0 ],
						"parameter_enable" : 0
					}
,
					"text" : "pattr position @bindto gridshape::quat",
					"varname" : "position[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 960.0, 18.0, 167.0, 18.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "SCALE" ],
						"parameter_enable" : 0
					}
,
					"text" : "pattr left3 @initial SCALE",
					"varname" : "left3"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 960.0, 54.0, 101.0, 18.0 ],
					"text" : "unpack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 960.0, 36.0, 227.0, 18.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ 1.0, 1.0, 1.0 ],
						"parameter_enable" : 0
					}
,
					"text" : "pattr scale @bindto gridshape::scale",
					"varname" : "scale"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1005.0, 83.0, 185.0, 18.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "POSITION" ],
						"parameter_enable" : 0
					}
,
					"text" : "pattr left8 @initial POSITION",
					"varname" : "left8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "float", "float" ],
					"patching_rect" : [ 1005.840027, 118.0, 101.0, 18.0 ],
					"text" : "unpack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1005.840027, 101.0, 263.0, 18.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ 0.0, 0.0, 0.0 ],
						"parameter_enable" : 0
					}
,
					"text" : "pattr position @bindto gridshape::position",
					"varname" : "position"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 570.0, 240.0, 89.0, 18.0 ],
					"text" : "prepend color"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 408.0, 165.0, 353.0, 18.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ 1.0, 1.0, 1.0, 1.0 ],
						"parameter_enable" : 0
					}
,
					"text" : "pattr color @bindto gridshape::color @initial 1. 1. 1. 1.",
					"varname" : "color"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 555.0, 186.0, 173.0, 18.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "COLOR" ],
						"parameter_enable" : 0
					}
,
					"text" : "pattr right4 @initial COLOR",
					"varname" : "right4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1327.923584, 74.5, 173.0, 18.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "SHAPE" ],
						"parameter_enable" : 0
					}
,
					"text" : "pattr right1 @initial SHAPE",
					"varname" : "right1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 375.0, 18.0, 203.0, 18.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "shape" ],
						"parameter_enable" : 0
					}
,
					"text" : "pattr device-type @initial shape",
					"varname" : "device-type"
				}
...
,
					"patching_rect" : [ 150.0, 600.0, 77.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Courier New",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.0, 585.0, 71.0, 18.0 ],
					"text" : "change-sym"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 198.5, 210.0, 100.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.0, 705.0, 95.0, 18.0 ],
					"text" : "pvar gridshape"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.0, 675.0, 65.0, 16.0 ],
					"text" : "drawto $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 59.0, 555.0, 113.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 92.0, 420.0, 89.0, 16.0 ],
					"text" : "getmarkerlist"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.0, 330.0, 107.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.0, 463.0, 77.0, 18.0 ],
					"text" : "pattrmarker"
				}
...
,
					"patching_rect" : [ 186.0, 463.0, 95.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Courier New",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 186.0, 495.0, 137.0, 18.0 ],
					"restore" : [ 159, 170 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 186.0, 390.0, 95.0, 16.0 ],
					"text" : "window getsize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 186.0, 420.0, 77.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 164.0, 360.0, 41.0, 18.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1329.291626, 57.5, 35.0, 16.0 ],
					"text" : "init"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1252.54834, 495.0, 16.291626, 18.0 ],
					"rounded" : 0.0,
					"text" : "~",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textovercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "bang", "" ],
					"patching_rect" : [ 831.973999, 390.0, 291.706055, 168.5 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 63.0, 141.129196, 29.0 ],
					"text" : "PATCHER"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 200.5, 47.0, 16.0 ],
					"text" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 20.708344, 182.5, 15.583313, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 8.0, 287.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 15.0, 95.0, 59.0, 18.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 117.0, 281.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 222.0, 77.0, 18.0 ],
					"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
					"text" : "thispatcher"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 53.0, 83.0, 16.0 ],
					"text" : "savewindow 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1329.291504, 90.5, 227.0, 18.0 ],
					"restore" : [ "sphere" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr shape @bindto gridshape::shape",
					"varname" : "shape"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 360.0, 53.0, 413.0, 18.0 ],
					"restore" : [ "u132004918" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr anim-name @bindto gridshape::name @autorestore 0 @invisible 1",
					"varname" : "anim-name"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 825.0, 62.0, 71.0, 18.0 ],
					"text" : "select 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 825.0, 134.0, 83.0, 16.0 ],
					"text" : "interval 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 851.0, 104.0, 101.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 825.0, 44.0, 47.0, 18.0 ],
					"text" : "active"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 390.0, 117.0, 407.0, 18.0 ],
					"text" : "jit.gl.gridshape @dim 100 100 @smooth_shading 1 @lighting_enable 1",
					"varname" : "gridshape"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 188.5, 63.0, 120.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1298.791626, 601.5, 1331.749878, 601.5 ],
					"source" : [ "obj-142", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1356.791626, 601.5, 1331.749878, 601.5 ],
					"source" : [ "obj-161", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 841.473999, 507.5, 381.5, 507.5, 381.5, 107.0, 399.5, 107.0 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-47" : [ "storagewindow", "storagewindow", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "preview.maxpat",
